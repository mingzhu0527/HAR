...
class Preprocess(object):
    ...
    def __init__(self,
        ...
        self._doc_filter_config = { 'enable': False, 'min_len': 0, 'max_len': six.MAXSIZE }
    ...
    def word_seg_en(docs):
        ...
        #             for j in range(sent_maxlen - len(sent)):
        #                 sent.append("_")
        #         else:
        #             sent = sent[:sent_maxlen]
        #         sent_list.append(sent)
        #     if len(sent_list) < sent_maxnum:
        #         for j in range(sent_maxnum - len(sent_list)):
        #             sent_list.append(["_"] * sent_maxnum)
        #     else:
